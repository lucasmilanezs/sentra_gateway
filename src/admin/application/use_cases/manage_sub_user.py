...
Use case para gerenciamento de members dentro de um tenant.
A application orquestra repositórios, hashing e auditoria; regras de acesso,
role e permissões ficam no domínio.
"""
import uuid
...
class ManageSubUser:
    ...
    async def update_permissions(
        ...
        *,
        ...
        updated = target.with_permissions(permissions, now=_utcnow())
