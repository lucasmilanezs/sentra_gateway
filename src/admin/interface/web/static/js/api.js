...
export const auditApi = {
  ...
  routeMetrics: (tenantId = null, seconds = 3600, bucketSeconds = 60, options = {}) => {
    const q = appendQuery(new URLSearchParams({ seconds: String(seconds), bucket_seconds: String(bucketSeconds) }), {
      tenant_id: tenantId,
